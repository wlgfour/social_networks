...
subtitle: "Using Exponential Random Graph Models and Sentiment Analysis"
author:
  - "William Gerecke"
...
I begin by describing how the data is gathered, cleaned, and parsed into a graphical structure. I proceed to elaborate on the model used for sentiment analysis, and the structure of ERGMs. After that, I discuss the results of applying these models to the data that was gathered in order to measure polarization in online communities. Finally I discuss weaknesses with the approach presented, the impact of the results, and suggest directions for future research.
